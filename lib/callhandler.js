        ...
        for (const call of callData) {
            if (call.status === 'offer') {
                ...
                await conn.sendMessage(callerId, {
                    text: `🚫 *Auto Call Rejection!*\n\ndear customer the person you are trying to reach is currently busy please hold or call back later TOXIC LOVER-V2 XMD is for you. Future calls may result in you being blocked.`,
                });
