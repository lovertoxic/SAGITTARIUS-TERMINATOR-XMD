...
cmd({
    ...
    try {
        await reply("🔍 Checking for 𝔗𝔈ℜ𝕄𝕀ℕ𝔸𝔗𝕆ℝ xmd updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your 𝔗𝔈ℜ𝕄𝕀ℕ𝔸𝔗𝕆ℝ xmd bot is already up-to-date!");
        }

        await reply("🚀 Updating 𝔗𝔈ℜ𝕄𝕀ℕ𝔸𝔗𝕆ℝ xmd Bot...");
        ...
        const sourcePath = path.join(extractPath, "SAGITTARIUS TERMINATOR XMD-main");
