...
ezra(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        let z =
            "Hello I'm *✧TOXIC LOVER-V2 XMD✧* \n\n " +
            "I'm a powerful Whatsapp Bot supporting you";
        let d = " Made By *sir bravin*";
        let varmess = z + d;
...
async function  execute  (origineMessage,zok) {
  console.log("Commande saisie !!!s")
   let z ='Salut je m\'appelle *ezra* \n\n '+'je suis un bot Whatsapp Multi-appareil '
      ...
      let varmess=z+d
      var img='https://files.catbox.moe/fzx87m.jpg'
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=254717263689:+254717263689\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
const sections = [
    ...
    },
   {
	...
	rows: [
	    ...
	    {title: "Option 4", rowId: "option4", description: "This is a description TOXIC LOVER-V2 XMD"}
	]
    },
]
