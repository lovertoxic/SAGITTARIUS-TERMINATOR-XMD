...
ezra({ nomCom: "forward", categorie: 'sir bravin-Group', reaction: "📤" }, async (dest, zk, commandeOptions) => {
  ...
  if ( verifAdmin | superUser ) {
    ...
    repondre('*TOXIC LOVER-V2 XMD Forwarded Your Message To All group members in their DMs.*');
  } else {
