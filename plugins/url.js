...
ezra({ nomCom: "url", categorie: "General-sir bravin", reaction: "👨🏿‍💻" }, async (origineMessage, zk, commandeOptions) => {
    ...
    try {
        ...
        switch (mediaType) {
            case 'image':
                repondre(`toxic lover-v2 xmd url: ${catboxUrl}`);
                break;
            case 'video':
                repondre(`toxic lover-v2 xmd url: ${catboxUrl}`);
                break;
...
ezra({nomCom:"sticker",categorie: "sir bravin-Conversion", reaction: "👨🏿‍💻"},async(origineMessage,zk,commandeOptions)=>{
...
const alea = (ext) => {
  ...
  if (mtype === "imageMessage" ||tagImage) {
    ...
    sticker = new Sticker(buffer, {
      pack:"TOXIC LOVER-V2 XMD", // pack stick
...
ezra({nomCom:"scrop",categorie: "sir bravin-Conversion", reaction: "👨🏿‍💻"},async(origineMessage,zk,commandeOptions)=>{
...
ezra({nomCom:"take",categorie: "sir bravin-Conversion", reaction: "👨🏿‍💻"},async(origineMessage,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
ezra({ nomCom: "write", categorie: "sir bravin-Conversion", reaction: "👨🏿‍💻" }, async (origineMessage, zk, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
...
ezra({nomCom:"photo",categorie: "sir bravin-Conversion", reaction: "👨🏿‍💻"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
