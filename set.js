...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/lovertoxic/TOXIC-LOVER-V2-XMD',
    ...
    URL: process.env.URL || "https://files.catbox.moe/12ry7x.jpg",  
    URL2: process.env.URL2 || "https://files.catbox.moe/12ry7x.jpg",
    ...
    CAPTION : process.env.CAPTION || "TOXIC LOVER-V2 XMD",
    BOT : process.env.BOT_NAME || 'TOXIC LOVER-V2 XMD',
