...
module.exports = { session: process.env.SESSION_ID || 'sir bravin',
    PREFIXE: process.env.PREFIX || "+",
    GITHUB : process.env.GITHUB|| 'https://github.com/lovertoxic/SAGITTARIUS-TERMINATOR-XMD',
    ...
    AUTO_STICKER : process.env.AUTO_STICKER || "no", 
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By sir bravin',   
    ...
    WEBSITE :process.env.GURL || "https://sir-bravine-delta.vercel.app/",
    CAPTION : process.env.CAPTION || "Terminator",
    BOT : process.env.BOT_NAME || 'terminator',
